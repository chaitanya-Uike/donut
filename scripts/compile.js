    ...
    return tplCreateElem({
        ...
        props: t.objectExpression([
            ...attributes.map(attribute => {
                return t.objectProperty(t.identifier(attribute.name.name), attribute.value.expression ?? attribute.value)
            }),
            t.objectProperty(t.identifier("children"), t.arrayExpression(children.reduce((acc, child) => {
